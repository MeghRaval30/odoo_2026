...
2. Read `claude/state/current-state.md` — the clock, the phase, what is broken.
3. Read `claude/state/task-board.md` — pick up the next unblocked task.
4. Skim `claude/context/decisions.md` — do not relitigate settled choices.
5. Append your opening entry to `claude/workflow/session-log.md`.
6. Announce to the user which character you are and what you are picking up.
